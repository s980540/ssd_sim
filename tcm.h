...
// #define CMP_CMD                 ((volatile ftl_cmp_info *)(CMP_CMD_BASE))
#define CMP_CMD                 ((ftl_cmp_info_t *)tcm_get_ptr(SYS_MEM_TYPE_B1TCM, CMP_CMD_IDX))
...
// #define COM_CMD_SQ0_FIFO(m) \
//     ((volatile u32 *)tcm_get_addr(SYS_MEM_TYPE_B1TCM, COM_CMD_SQ0_FIFO_IDX) \
//         + (m) * COM_CMD_SQ_FIFO_ENTRY_SIZE)
...
#define r_pause_write \
    (*(volatile u8 *)(tcm_get_ptr(SYS_MEM_TYPE_B1TCM, SHARED_VAR_IDX) + 0x000a))
